        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">مرجبا
                  <span
                      class="user-name text-bold-700">  {{auth::check() ? auth::user()->name : 'admin'}}</span>
                </span>
                            <span class="avatar avatar-online">
                  <img  style="height: 35px;" src="{{asset('assest/admin/images/portrait/small/avatar-s-19.png')}}" alt="avatar"><i></i></span>
                        </a>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="{{asset('assest/admin/images/portrait/small/avatar-s-19.png')}}"
                               alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                        ...
                        <span class="avatar avatar-sm avatar-busy rounded-circle">
                          <img src="{{asset('assest/admin/images/portrait/small/avatar-s-2.png')}}" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="{{asset('assest/admin/images/portrait/small/avatar-s-3.png')}}" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                        ...
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                          <img src="{{asset('assest/admin/images/portrait/small/avatar-s-6.png')}}" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
