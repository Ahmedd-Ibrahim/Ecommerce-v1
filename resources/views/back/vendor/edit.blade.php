                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">تعديل التاجر</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.vendor.update',$vendor->id)}}"
                                              method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                أترك أى حقل فارغ أذا كنت لا تريد تحديثة*
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="projectinput2"> تعديل القسم   </label>
                                                            <select class="selectBox border-success bg-white form-control" name="category_id">
                                                                <optgroup label="من فضلك اختر القسم">
                                                                    <option value="{{$vendor->category_id}}">{{$vendor->category->name}}</option>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> ادخل باسورد جديد  </label>
