...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assest/front/css/bootstrap.min.css')}}" media="all"/>
    <link rel="stylesheet" type="text/css" href="{{asset('assest/front/css/font-awesome.min.css')}}" media="all"/>
    <link rel="stylesheet" type="text/css" href="{{asset('assest/front/css/animate.min.css')}}" media="all"/>
    <link rel="stylesheet" type="text/css" href="{{asset('assest/front/css/font-electro.css')}}" media="all"/>
    <link rel="stylesheet" type="text/css" href="{{asset('assest/front/css/owl-carousel.css')}}" media="all"/>
    <link rel="stylesheet" type="text/css" href="{{asset('assest/front/css/style.css')}}" media="all"/>
    <link rel="stylesheet" type="text/css" href="{{asset('assest/front/css/colors/yellow.css')}}" media="all"/>
    ...
    <link rel="shortcut icon" href="{{asset('assest/front/images/fav-icon.png')}}">
</head>
                    ...
                    <li class="nav-item dropdown">
                        <a href="cart.html" class="nav-link" data-toggle="dropdown">
                            ...
                            <span class="cart-items-total-price total-price"><span
                                    class="amount">&#36;1,215.00</span></span>
                        </a>
                                ...
                                <div class="widget_shopping_cart_content">
                                    ...
                                    <ul class="cart_list product_list_widget ">
                                        ...
                                        <li class="mini_cart_item">
                                            ...
                                            <a href="single-product.html">
                                                <img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image"
                                                     src="assest/front/images/products/mini-cart1.jpg" alt="">White
                                                lumia 9001&nbsp;
                                            </a>
                                        ...
                                        <li class="mini_cart_item">
                                            ...
                                            <a href="single-product.html">
                                                <img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image"
                                                     src="assest/front/images/products/mini-cart2.jpg" alt="">PlayStation
                                                4&nbsp;
                                            </a>
                                        ...
                                        <li class="mini_cart_item">
                                            ...
                                            <a href="single-product.html">
                                                <img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image"
                                                     src="assest/front/images/products/mini-cart3.jpg" alt="">POV Action
                                                Cam HDR-AS100V&nbsp;
                ...
                <div class="col-xs-12 col-lg-3">
                    <nav>
                        <ul class="list-group vertical-menu yamm make-absolute">
                            ...
                            <li class="highlight menu-item animate-dropdown"><a title="Value of the Day"
                                                                                href="home-v2.html">Value of the Day</a>
                            </li>

                            <li class="highlight menu-item animate-dropdown"><a title="Top 100 Offers"
                                                                                href="home-v3.html">Top 100 Offers</a>
                            </li>
                            ...
                            <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown">
                                <a title="Computers &amp; Accessories" data-hover="dropdown"
                                ...
                                <ul role="menu" class=" dropdown-menu">
                                    <li class="menu-item animate-dropdown menu-item-object-static_block">
                                        <div class="yamm-content">
                                            <div
                                                class="row bg-yamm-content bg-yamm-content-bottom bg-yamm-content-right">
                                                <div class="col-sm-12">
                                                            ...
                                                            <div
                                                                ...
                                                                <figure class="wpb_wrapper vc_figure">
                                                                    <div
                                                                        ...
                                                                        <img src="assest/front/images/megamenu-2.png"
                                                                ...
                                                                <div class="wpb_wrapper">
                                                                    <ul>
                                                                        ...
                                                                        <li><a href="#"><span class="nav-text">All Electronics</span><span
                                                                                    class="nav-subtext">Discover more products</span></a>
                                                                        </li>
                                                                    </ul>
                            ...
                            <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown">
                                <a title="Cameras, Audio &amp; Video" data-hover="dropdown" href="product-category.html"
                            ...
                            <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown">
                                <a title="Mobiles &amp; Tablets" data-hover="dropdown" href="product-category.html"
                                   data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">Mobiles &#038;
                                    Tablets</a>
                                <ul role="menu" class=" dropdown-menu">
                                    <li class="menu-item animate-dropdown menu-item-object-static_block">
                                        <div class="yamm-content">
                            ...
                            <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown">
                                <a title="Movies, Music &amp; Video Games" data-hover="dropdown"
                                   href="product-category.html" data-toggle="dropdown" class="dropdown-toggle"
                            ...
                            <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown">
                                <a title="TV &amp; Audio" data-hover="dropdown" href="product-category.html"
                                   data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">TV &#038;
                                    Audio</a>
                                <ul role="menu" class=" dropdown-menu">
                                    <li class="menu-item animate-dropdown menu-item-object-static_block">
                                        <div class="yamm-content">
                            ...
                            <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown">
                                <a title="Watches &amp; Eyewear" data-hover="dropdown" href="product-category.html"
                                   data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">Watches &#038;
                                    Eyewear</a>
                                <ul role="menu" class=" dropdown-menu">
                                    <li class="menu-item animate-dropdown menu-item-object-static_block">
                                        <div class="yamm-content">
                            ...
                            <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown">
                                <a title="Car, Motorbike &amp; Industrial" data-hover="dropdown"
                                   href="product-category.html" data-toggle="dropdown" class="dropdown-toggle"
                            ...
                            <li id="menu-item-2695" class="menu-item menu-item-has-children animate-dropdown dropdown">
                                <a title="Accessories" data-hover="dropdown" href="product-category.html"
                                   data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">Accessories</a>
                                <ul role="menu" class=" dropdown-menu">
                                    <li class="menu-item animate-dropdown"><a title="Cases"
                                                                              href="product-category.html">Cases</a>
                                    </li>
                                    <li class="menu-item animate-dropdown"><a title="Chargers"
                                                                              href="product-category.html">Chargers</a>
                                    </li>
                                    <li class="menu-item animate-dropdown"><a title="Headphone Accessories"
                                                                              href="product-category.html">Headphone
                                            Accessories</a></li>
                                    <li class="menu-item animate-dropdown"><a title="Headphone Cases"
                                                                              href="product-category.html">Headphone
                                            Cases</a></li>
                                    <li class="menu-item animate-dropdown"><a title="Headphones"
                                                                              href="product-category.html">Headphones</a>
                                    </li>
                                    <li class="menu-item animate-dropdown"><a title="Computer Accessories"
                                                                              href="product-category.html">Computer
                                            Accessories</a></li>
                                    <li class="menu-item animate-dropdown"><a title="Laptop Accessories"
                                                                              href="product-category.html">Laptop
                                            Accessories</a></li>
                                </ul>
                            </li>
                        </ul>
                ...
                <div class="col-xs-12 col-lg-9">
                    <nav>
                        <ul id="menu-secondary-nav" class="secondary-nav">
                            ...
                            <li class="pull-right menu-item"><a href="blog-v2.html">Free Shipping on Orders $50+</a>
                            </li>
                        </ul>
                    </nav>
                </div>
                ...
                <main id="main" class="site-main">
                    <div class="home-v1-slider">
                        ...
                        <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                            ...
                            <div class="item" style="background-image: url(assest/front/images/slider/banner-2.jpg);">
                                <div class="container">
                                    <div class="row">
                            ...
                            <div class="item" style="background-image: url(assest/front/images/slider/banner-1.jpg);">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-5">
                                            <div class="caption vertical-center text-left">
                            ...
                            <div class="item" style="background-image: url(assest/front/images/slider/banner-3.jpg);">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-5">
                                            <div class="caption vertical-center text-left">
                    ...
                    <div class="home-v1-ads-block animate-in-view fadeIn animated" data-animation="fadeIn">
                        <div class="ads-block row">
                            <div class="ad col-xs-12 col-sm-4">
                                <div class="media">
                                    <div class="media-left media-middle">
                                        <img data-echo="assest/front/images/banner/cameras.jpg"
                                             src="assest/front/images/blank.gif" alt="">
                                    </div>
                            ...
                            <div class="ad col-xs-12 col-sm-4">
                                <div class="media">
                                    <div class="media-left media-middle">
                                        <img data-echo="assest/front/images/banner/MobileDevicesv2-2.jpg"
                                             src="assest/front/images/blank.gif" alt="">
                                    </div>
                                    <div class="media-body media-middle">
                                        <div class="ad-text">
                            ...
                            <div class="ad col-xs-12 col-sm-4">
                                <div class="media">
                                    <div class="media-left media-middle">
                                        <img data-echo="assest/front/images/banner/DesktopPC.jpg"
                                             src="assest/front/images/blank.gif" alt="">
                                    </div>
                                    <div class="media-body media-middle">
                                        <div class="ad-text">
                                        ...
                                        <a href="shop.html">
                                            <div class="product-thumbnail">
                                                <img class="wp-post-image"
                                                     data-echo="assest/front/images/onsale-product.jpg"
                                                     src="assest/front/images/blank.gif" alt=""></div>
                                            ...
                                            <ul class="products columns-3">
                                                    ...
                                                    <div class="product-outer">
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    <img src="assest/front/images/blank.gif"
                                                                         data-echo="assest/front/images/products/1.jpg"
                                                    ...
                                                    <div class="product-outer">
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    <img src="assest/front/images/blank.gif"
                                                                         data-echo="assest/front/images/products/2.jpg"
                                                                         class="img-responsive" alt="">
                                                                </div>
                                                            </a>
                                                    ...
                                                    <div class="product-outer">
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    <img src="assest/front/images/blank.gif"
                                                                         data-echo="assest/front/images/products/3.jpg"
                                                                         class="img-responsive" alt="">
                                                                </div>
                                                            </a>
                                                    ...
                                                    <div class="product-outer">
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    <img src="assest/front/images/blank.gif"
                                                                         data-echo="assest/front/images/products/4.jpg"
                                                                         class="img-responsive" alt="">
                                                                </div>
                                                            </a>
                                                            ...
                                                            <div class="price-add-to-cart">
                                                                        <span class="price">
                                                                            <span class="electro-price">
                                                                                <ins><span
                                                                                        class="amount"> $1,215.00</span></ins>
                                                                                <del><span
                                                                                        class="amount">$2,215.00</span></del>
                                                                                <span class="amount"> </span>
                                                                            </span>
                                                                        </span>
                                                                <a rel="nofollow" href="single-product.html"
                                                    ...
                                                    <div class="product-outer">
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    <img src="assest/front/images/blank.gif"
                                                                         data-echo="assest/front/images/products/5.jpg"
                                                                         class="img-responsive" alt="">
                                                                </div>
                                                            </a>
                                                ...
                                                <li class="product last">
                                                    <div class="product-outer">
                                                        <div class="product-inner">
                                                            <span class="loop-product-categories"><a
                                                                    href="product-category.html" rel="tag">Printers</a></span>
                                                            <a href="single-product.html">
                                                                <h3>Full Color LaserJet Pro M452dn</h3>
                                                                <div class="product-thumbnail">
                                                                    <img src="assest/front/images/blank.gif"
                                                                         data-echo="assest/front/images/products/6.jpg"
                                                                         class="img-responsive" alt="">
                                                                </div>
                                                            </a>
                                                        ...
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    ...
                                                                    <img data-echo="assest/front/images/products/3.jpg"
                                                                         src="assest/front/images/blank.gif" alt="">
                                                        ...
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    ...
                                                                    <img data-echo="assest/front/images/products/5.jpg"
                                                                         src="assest/front/images/blank.gif" alt="">
                                                        ...
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    ...
                                                                    <img data-echo="assest/front/images/products/4.jpg"
                                                                         src="assest/front/images/blank.gif" alt="">
                                                        ...
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    ...
                                                                    <img data-echo="assest/front/images/products/1.jpg"
                                                                         src="assest/front/images/blank.gif" alt="">
                                                        ...
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    ...
                                                                    <img data-echo="assest/front/images/products/6.jpg"
                                                                         src="assest/front/images/blank.gif" alt="">
                                                        ...
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    ...
                                                                    <img data-echo="assest/front/images/products/2.jpg"
                                                                         src="assest/front/images/blank.gif" alt="">
                                            ...
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        ...
                                                        <img data-echo="assest/front/images/product-2-1-2/1.jpg"
                                                             src="assest/front/images/blank.gif" alt="">
                                            ...
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        ...
                                                        <img data-echo="assest/front/images/product-2-1-2/4.jpg"
                                                             src="assest/front/images/blank.gif" alt="">
                                        ...
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        <img class="wp-post-image"
                                                             data-echo="assest/front/images/product-2-1-2/main.jpg"
                                                             src="assest/front/images/blank.gif" alt="">
                                            ...
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        ...
                                                        <img class="wp-post-image"
                                                             data-echo="assest/front/images/product-2-1-2/1.jpg"
                                                             src="assest/front/images/blank.gif" alt="">
                                            ...
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        ...
                                                        <img class="wp-post-image"
                                                             data-echo="assest/front/images/product-2-1-2/4.jpg"
                                                             src="assest/front/images/blank.gif" alt="">
                                                ...
                                                <a class="media-left" href="single-product.html"
                                                   title="Pendrive USB 3.0 Flash 64 GB">
                                                    <img class="media-object wp-post-image img-responsive"
                                                         src="assest/front/images/blank.gif"
                                                         data-echo="assest/front/images/product-cards/4.jpg" alt="">
                                                </a>
                                            ...
                                            <div class="media product-inner">
                                                ...
                                                <a class="media-left" href="single-product.html"
                                                   title="Pendrive USB 3.0 Flash 64 GB">
                                                    <img class="media-object wp-post-image img-responsive"
                                                         src="assest/front/images/blank.gif"
                                                         data-echo="assest/front/images/product-cards/6.jpg" alt="">
                                                </a>
                                            ...
                                            <div class="media product-inner">
                                                ...
                                                <a class="media-left" href="single-product.html"
                                                   title="Pendrive USB 3.0 Flash 64 GB">
                                                    <img class="media-object wp-post-image img-responsive"
                                                         src="assest/front/images/blank.gif"
                                                         data-echo="assest/front/images/product-cards/5.jpg" alt="">
                                                </a>
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="price-add-to-cart">
                                                                <span class="price">
                                                                    <span class="electro-price">
                                                                        <ins><span
                                                                                class="amount"> $3,788.00</span></ins>
                                                ...
                                                <a class="media-left" href="single-product.html"
                                                   title="Pendrive USB 3.0 Flash 64 GB">
                                                    <img class="img-responsive media-object wp-post-image"
                                                         src="assest/front/images/blank.gif"
                                                         data-echo="assest/front/images/product-cards/1.jpg" alt="">
                                            ...
                                            <div class="media product-inner">
                                                ...
                                                <a class="media-left" href="single-product.html"
                                                   title="Pendrive USB 3.0 Flash 64 GB">
                                                    <img class="img-responsive media-object wp-post-image"
                                                         src="assest/front/images/blank.gif"
                                                         data-echo="assest/front/images/product-cards/3.jpg" alt="">
                                                </a>
                                            ...
                                            <div class="media product-inner">
                                                ...
                                                <a class="media-left" href="single-product.html"
                                                   title="Pendrive USB 3.0 Flash 64 GB">
                                                    <img class="img-responsive media-object wp-post-image"
                                                         src="assest/front/images/blank.gif"
                                                         data-echo="assest/front/images/product-cards/2.jpg" alt="">
                                                </a>
                    ...
                    <div class="home-v1-banner-block animate-in-view fadeIn animated" data-animation="fadeIn">
                        <div class="home-v1-fullbanner-ad fullbanner-ad" style="margin-bottom: 70px">
                            <a href="#"><img src="assest/front/images/blank.gif"
                                             data-echo="assest/front/images/banner/home-v1-banner.png"
                                        ...
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        <img src="assest/front/images/blank.gif"
                                                             data-echo="assest/front/images/product-category/2.jpg"
                                                             class="img-responsive" alt="">
                                                    </div>
                                                </a>
                                        ...
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        <img src="assest/front/images/blank.gif"
                                                             data-echo="assest/front/images/product-category/3.jpg"
                                                             class="img-responsive" alt="">
                                                    </div>
                                                </a>
                                        ...
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        <img src="assest/front/images/blank.gif"
                                                             data-echo="assest/front/images/product-category/1.jpg"
                                                             class="img-responsive" alt="">
                                                    </div>
                                                </a>
                                        ...
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        <img src="assest/front/images/blank.gif"
                                                             data-echo="assest/front/images/product-category/5.jpg"
                                                             class="img-responsive" alt="">
                                                    </div>
                                                </a>
                                        ...
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        <img src="assest/front/images/blank.gif"
                                                             data-echo="assest/front/images/product-category/4.jpg"
                                                             class="img-responsive" alt="">
                                                    </div>
                                                </a>
                                        ...
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        <img src="assest/front/images/blank.gif"
                                                             data-echo="assest/front/images/product-category/6.jpg"
                                                             class="img-responsive" alt="">
                                                    </div>
                                                </a>
                ...
                <div class="item">
                    ...
                    <a href="#">
                        ...
                        <figure>
                            ...
                            <img src="assest/front/images/blank.gif" data-echo="assest/front/images/brands/1.png"
                                 class="img-responsive" alt="">
                ...
                <div class="item">
                    ...
                    <a href="#">
                        ...
                        <figure>
                            ...
                            <img src="assest/front/images/blank.gif" data-echo="assest/front/images/brands/2.png"
                                 class="img-responsive" alt="">
                ...
                <div class="item">
                    ...
                    <a href="#">
                        ...
                        <figure>
                            ...
                            <img src="assest/front/images/blank.gif" data-echo="assest/front/images/brands/3.png"
                                 class="img-responsive" alt="">
                ...
                <div class="item">
                    ...
                    <a href="#">
                        ...
                        <figure>
                            ...
                            <img src="assest/front/images/blank.gif" data-echo="assest/front/images/brands/4.png"
                                 class="img-responsive" alt="">
                ...
                <div class="item">
                    ...
                    <a href="#">
                        ...
                        <figure>
                            ...
                            <img src="assest/front/images/blank.gif" data-echo="assest/front/images/brands/5.png"
                                 class="img-responsive" alt="">
                ...
                <div class="item">
                    ...
                    <a href="#">
                        ...
                        <figure>
                            ...
                            <img src="assest/front/images/blank.gif" data-echo="assest/front/images/brands/6.png"
                                 class="img-responsive" alt="">
                                ...
                                <ul class="product_list_widget">
                                    <li>
                                        <a href="single-product.html" title="Tablet Thin EliteBook  Revolve 810 G6">
                                            <img class="wp-post-image" data-echo="assest/front/images/footer/1.jpg"
                                                 src="assest/front/images/blank.gif" alt="">
                                    ...
                                    <li>
                                        <a href="single-product.html" title="Smartphone 6S 128GB LTE">
                                            <img class="wp-post-image" data-echo="assest/front/images/footer/2.jpg"
                                                 src="assest/front/images/blank.gif" alt=""><span class="product-title">Smartphone 6S 128GB LTE</span>
                                        </a>
                                    ...
                                    <li>
                                        <a href="single-product.html" title="Smartphone 6S 64GB LTE">
                                            <img class="wp-post-image" data-echo="assest/front/images/footer/3.jpg"
                                                 src="assest/front/images/blank.gif" alt="">
                                ...
                                <ul class="product_list_widget">
                                    ...
                                    <li>
                                        <a href="single-product.html" title="Tablet Red EliteBook  Revolve 810 G2">
                                            <img class="wp-post-image" data-echo="assest/front/images/footer/4.jpg"
                                                 src="assest/front/images/blank.gif" alt="">
                                    ...
                                    <li>
                                        <a href="single-product.html" title="Widescreen 4K SUHD TV">
                                            <img class="wp-post-image" data-echo="assest/front/images/footer/5.jpg"
                                                 src="assest/front/images/blank.gif" alt="">
                        ...
                        <aside class="widget clearfix">
                            <div class="body">
                                ...
                                <ul class="product_list_widget">
                                    <li>
                                        <a href="single-product.html" title="Notebook Black Spire V Nitro  VN7-591G">
                                            <img class="wp-post-image" data-echo="assest/front/images/footer/6.jpg"
                                                 src="assest/front/images/blank.gif" alt="">
                                            <span class="product-title">Notebook Black Spire V Nitro  VN7-591G</span>
                                        </a>
                                    ...
                                    <li>
                                        <a href="single-product.html"
                                           title="Apple MacBook Pro MF841HN/A 13-inch Laptop">
                                            <img class="wp-post-image" data-echo="assest/front/images/footer/7.jpg"
                                                 src="assest/front/images/blank.gif" alt="">
                                            <span
                ...
                <div class="pull-right flip payment">
                    <div class="footer-payment-logo">
                        <ul class="cash-card card-inline">
                            <li class="card-item"><img src="assest/front/images/footer/payment-icon/1.png" alt=""
                                                       width="52"></li>
                            <li class="card-item"><img src="assest/front/images/footer/payment-icon/2.png" alt=""
                                                       width="52"></li>
                            <li class="card-item"><img src="assest/front/images/footer/payment-icon/3.png" alt=""
                                                       width="52"></li>
                            <li class="card-item"><img src="assest/front/images/footer/payment-icon/4.png" alt=""
                                                       width="52"></li>
                            <li class="card-item"><img src="assest/front/images/footer/payment-icon/5.png" alt=""
                                                       width="52"></li>
                        </ul>
                    </div><!-- /.payment-methods -->
                </div>
...
<script type="text/javascript" src="{{asset('assest/front/js/tether.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assest/front/js/bootstrap.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assest/front/js/bootstrap-hover-dropdown.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assest/front/js/owl.carousel.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assest/front/js/echo.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assest/front/js/wow.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assest/front/js/jquery.easing.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assest/front/js/jquery.waypoints.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assest/front/js/electro.js')}}"></script>
