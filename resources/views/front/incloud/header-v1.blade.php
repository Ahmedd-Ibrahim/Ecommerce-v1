                                ...
                                <ul class="cart_list product_list_widget ">
                                    ...
                                    <li class="mini_cart_item">
                                        ...
                                        <a href="single-product.html">
                                            <img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" src="assest/front/images/products/mini-cart1.jpg" alt="">White lumia 9001&nbsp;
                                        </a>
                                    ...
                                    <li class="mini_cart_item">
                                        <a title="Remove this item" class="remove" href="#">×</a>
                                        <a href="single-product.html">
                                            <img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" src="assest/front/images/products/mini-cart2.jpg" alt="">PlayStation 4&nbsp;
                                        </a>
                                    ...
                                    <li class="mini_cart_item">
                                        ...
                                        <a href="single-product.html">
                                        <img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" src="assest/front/images/products/mini-cart3.jpg" alt="">POV Action Cam HDR-AS100V&nbsp;
                                                        ...
                                                        <div class="wpb_single_image wpb_content_element vc_align_left">
                                                            <figure class="wpb_wrapper vc_figure">
                                                                <div class="vc_single_image-wrapper vc_box_border_grey">
                                                                    ...
                                                                    <img src="assest/front/images/megamenu-2.png" class="vc_single_image-img attachment-full" alt="">
                                                                </div>
                                                            </figure>
                                                        </div>
                                                    </div>
