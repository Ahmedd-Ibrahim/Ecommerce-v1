...
<main id="main-site" class="displayhomenovthree">
    ...
    <header id="header" class="header-3 sticky-menu">
        ...
        @include('front.incloud.header-mobile')
        @include('front.incloud.header-top')
        @include('front.incloud.header-center')
        @include('front.incloud.header-bottom')
