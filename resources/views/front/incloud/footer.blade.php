            							...
            							<ul class="product_list_widget">
            								<li>
            									<a href="single-product.html" title="Tablet Thin EliteBook  Revolve 810 G6">
            										<img class="wp-post-image" data-echo="assest/front/images/footer/1.jpg" src="assest/front/images/blank.gif" alt="">
            								...
            								<li>
            									<a href="single-product.html" title="Smartphone 6S 128GB LTE">
            										<img class="wp-post-image" data-echo="assest/front/images/footer/2.jpg" src="assest/front/images/blank.gif" alt=""><span class="product-title">Smartphone 6S 128GB LTE</span>
            									</a>
            								...
            								<li>
            									<a href="single-product.html" title="Smartphone 6S 64GB LTE">
            										<img class="wp-post-image" data-echo="assest/front/images/footer/3.jpg" src="assest/front/images/blank.gif" alt="">
            							...
            							<ul class="product_list_widget">
            								...
            								<li>
            									<a href="single-product.html" title="Tablet Red EliteBook  Revolve 810 G2">
            										<img class="wp-post-image" data-echo="assest/front/images/footer/4.jpg" src="assest/front/images/blank.gif" alt="">
            								...
            								<li>
            									<a href="single-product.html" title="Widescreen 4K SUHD TV">
            										<img class="wp-post-image" data-echo="assest/front/images/footer/5.jpg" src="assest/front/images/blank.gif" alt="">
            					...
            					<aside class="widget clearfix">
            						<div class="body">
            							...
            							<ul class="product_list_widget">
            								<li>
            									<a href="single-product.html" title="Notebook Black Spire V Nitro  VN7-591G">
            										<img class="wp-post-image" data-echo="assest/front/images/footer/6.jpg" src="assest/front/images/blank.gif" alt="">
            										<span class="product-title">Notebook Black Spire V Nitro  VN7-591G</span>
            									</a>
            								...
            								<li>
            									<a href="single-product.html" title="Apple MacBook Pro MF841HN/A 13-inch Laptop">
            										<img class="wp-post-image" data-echo="assest/front/images/footer/7.jpg" src="assest/front/images/blank.gif" alt="">
            								...
            								<li>
            									<a href="single-product.html" title="Tablet White EliteBook Revolve  810 G2">
            										<img class="wp-post-image" data-echo="assest/front/images/footer/2.jpg" src="assest/front/images/blank.gif" alt="">
            			...
            			<div class="pull-right flip payment">
            				<div class="footer-payment-logo">
            					<ul class="cash-card card-inline">
            						<li class="card-item"><img src="assest/front/images/footer/payment-icon/1.png" alt="" width="52"></li>
            						<li class="card-item"><img src="assest/front/images/footer/payment-icon/2.png" alt="" width="52"></li>
            						<li class="card-item"><img src="assest/front/images/footer/payment-icon/3.png" alt="" width="52"></li>
            						<li class="card-item"><img src="assest/front/images/footer/payment-icon/4.png" alt="" width="52"></li>
            						<li class="card-item"><img src="assest/front/images/footer/payment-icon/5.png" alt="" width="52"></li>
            					</ul>
            				</div><!-- /.payment-methods -->
            			</div>
            		</div><!-- /.container -->
