    ...
    <main id="main" class="site-main">
        <div class="home-v1-slider" >
            ...
            <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                ...
                <div class="item" style="background-image: url({{asset('assest/front/images/slider/banner-2.jpg')}});">
                    <div class="container">
                        <div class="row">
                ...
                <div class="item" style="background-image: url({{asset('assest/front/images/slider/banner-3.jpg')}});">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-5">
                                <div class="caption vertical-center text-left">
        ...
        <div class="home-v1-ads-block animate-in-view fadeIn animated" data-animation="fadeIn">
            <div class="ads-block row">
                <div class="ad col-xs-12 col-sm-4">
                    <div class="media">
                        <div class="media-left media-middle">
                            <img data-echo="{{asset('assest/front/images/banner/cameras.jpg')}}" src="{{asset('assest/front/images/blank.gif')}}" alt="">
                        </div>
                ...
                <div class="ad col-xs-12 col-sm-4">
                    <div class="media">
                        <div class="media-left media-middle">
                            <img data-echo="{{asset('assest/front/images/banner/MobileDevicesv2-2.jpg')}}" src="assest/front/images/blank.gif" alt="">
                        </div>
                        <div class="media-body media-middle">
                            <div class="ad-text">
                ...
                <div class="ad col-xs-12 col-sm-4">
                    <div class="media">
                        <div class="media-left media-middle">
                            <img data-echo="{{asset('assest/front/images/banner/DesktopPC.jpg')}}" src="{{asset('assest/front/images/blank.gif')}}" alt="">
                        </div>
                        <div class="media-body media-middle">
                            <div class="ad-text">
                        ...
                        <div class="onsale-product">
                            <a href="shop.html">
                                <div class="product-thumbnail">
                                    <img class="wp-post-image" data-echo="{{asset('assest/front/images/onsale-product.jpg')}}" src="{{asset('assest/front/images/blank.gif')}}" alt=""></div>
                                        ...
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        <img src="{{asset('assest/front/images/blank.gif')}}" data-echo="{{asset('assest/front/images/products/1.jpg')}}" class="img-responsive" alt="">
                                                    </div>
                                                </a>
                                        ...
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        <img src="assest/front/images/blank.gif" data-echo="assest/front/images/products/2.jpg" class="img-responsive" alt="">
                                                    </div>
                                                </a>
                                        ...
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        <img src="assest/front/images/blank.gif" data-echo="assest/front/images/products/3.jpg" class="img-responsive" alt="">
                                                    </div>
                                                </a>
                                        ...
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        <img src="{{asset('assest/front/images/blank.gif')}}" data-echo="{{asset('assest/front/images/products/4.jpg')}}" class="img-responsive" alt="">
                                                    </div>
                                                </a>
                                        ...
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        <img src="assest/front/images/blank.gif" data-echo="assest/front/images/products/5.jpg" class="img-responsive" alt="">
                                                    </div>
                                                </a>
                                        ...
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        <img src="assest/front/images/blank.gif" data-echo="assest/front/images/products/6.jpg" class="img-responsive" alt="">
                                                    </div>
                                                </a>
                                            ...
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        ...
                                                        <img data-echo="assest/front/images/products/3.jpg" src="assest/front/images/blank.gif" alt="">
                                            ...
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        ...
                                                        <img data-echo="assest/front/images/products/5.jpg" src="assest/front/images/blank.gif" alt="">
                                            ...
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        ...
                                                        <img data-echo="assest/front/images/products/4.jpg" src="assest/front/images/blank.gif" alt="">
                                            ...
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        ...
                                                        <img data-echo="assest/front/images/products/1.jpg" src="assest/front/images/blank.gif" alt="">
                                            ...
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        ...
                                                        <img data-echo="assest/front/images/products/6.jpg" src="assest/front/images/blank.gif" alt="">
                                            ...
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        ...
                                                        <img data-echo="assest/front/images/products/2.jpg" src="assest/front/images/blank.gif" alt="">
                                        ...
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    <h3>Wireless Audio System Multiroom 360</h3>
                                                    <div class="product-thumbnail">
                                                        <img src="assest/front/images/blank.gif" data-echo="assest/front/images/products/1.jpg" class="img-responsive" alt="">
                                                    </div>
                                                </a>
                                        ...
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    <h3>Smartphone 6S 32GB LTE</h3>
                                                    <div class="product-thumbnail">
                                                        <img src="assest/front/images/blank.gif" data-echo="assest/front/images/products/4.jpg" class="img-responsive" alt="">
                                                    </div>
                                                </a>
                                ...
                                <div class="product-inner">
                                    ...
                                    <a href="single-product.html">
                                        ...
                                        <div class="product-thumbnail">
                                            ...
                                            <img data-echo="assest/front/images/product-2-1-2/1.jpg" src="assest/front/images/blank.gif" alt="">
                                ...
                                <div class="product-inner">
                                    ...
                                    <a href="single-product.html">
                                        ...
                                        <div class="product-thumbnail">
                                            ...
                                            <img data-echo="assest/front/images/product-2-1-2/4.jpg" src="assest/front/images/blank.gif" alt="">
                            ...
                            <div class="product-outer">
                                <div class="product-inner">
                                    ...
                                    <a href="single-product.html">
                                        <h3>Notebook Black Spire V Nitro  VN7-591G</h3>
                                        <div class="product-thumbnail">
                                            <img class="wp-post-image" data-echo="assest/front/images/product-2-1-2/main.jpg" src="assest/front/images/blank.gif" alt="">
                                ...
                                <div class="product-inner">
                                    ...
                                    <a href="single-product.html">
                                        ...
                                        <div class="product-thumbnail">
                                            ...
                                            <img class="wp-post-image" data-echo="assest/front/images/product-2-1-2/1.jpg" src="assest/front/images/blank.gif" alt="">
                                ...
                                <div class="product-inner">
                                    ...
                                    <a href="single-product.html">
                                        ...
                                        <div class="product-thumbnail">
                                            ...
                                            <img class="wp-post-image" data-echo="assest/front/images/product-2-1-2/4.jpg" src="assest/front/images/blank.gif" alt="">
                            ...
                            <div class="product-outer">
                                <div class="media product-inner">
                                    ...
                                    <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                        <img class="media-object wp-post-image img-responsive" src="assest/front/images/blank.gif" data-echo="assest/front/images/product-cards/4.jpg" alt="">
                                    </a>
                        ...
                        <li class="product product-card ">
                            ...
                            <div class="product-outer">
                                <div class="media product-inner">
                                    ...
                                    <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                        <img class="media-object wp-post-image img-responsive" src="assest/front/images/blank.gif" data-echo="assest/front/images/product-cards/6.jpg" alt="">
                                    </a>
                        ...
                        <li class="product product-card last">
                            ...
                            <div class="product-outer">
                                <div class="media product-inner">
                                    ...
                                    <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                        <img class="media-object wp-post-image img-responsive" src="assest/front/images/blank.gif" data-echo="assest/front/images/product-cards/5.jpg" alt="">
                                    </a>
                        ...
                        <li class="product product-card first">
                            ...
                            <div class="product-outer">
                                <div class="media product-inner">
                                    ...
                                    <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                        <img class="img-responsive media-object wp-post-image" src="assest/front/images/blank.gif" data-echo="assest/front/images/product-cards/1.jpg" alt="">
                        ...
                        <li class="product product-card ">
                            ...
                            <div class="product-outer">
                                <div class="media product-inner">
                                    ...
                                    <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                        <img class="img-responsive media-object wp-post-image" src="assest/front/images/blank.gif" data-echo="assest/front/images/product-cards/3.jpg" alt="">
                                    </a>
                        ...
                        <li class="product product-card last">
                            ...
                            <div class="product-outer">
                                <div class="media product-inner">
                                    ...
                                    <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                        <img class="img-responsive media-object wp-post-image" src="assest/front/images/blank.gif" data-echo="assest/front/images/product-cards/2.jpg" alt="">
                                    </a>
                        ...
                        <li class="product product-card ">
                            ...
                            <div class="product-outer">
                                <div class="media product-inner">
                                    ...
                                    <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                        <img class="img-responsive media-object wp-post-image" src="assest/front/images/blank.gif" data-echo="assest/front/images/product-cards/5.jpg" alt="">
                                    </a>
                        ...
                        <li class="product product-card last">
                            ...
                            <div class="product-outer">
                                <div class="media product-inner">
                                    ...
                                    <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                        <img class="img-responsive media-object wp-post-image" src="assest/front/images/blank.gif" data-echo="assest/front/images/product-cards/4.jpg" alt="">
                                    </a>
                        ...
                        <li class="product product-card ">
                            ...
                            <div class="product-outer">
                                <div class="media product-inner">
                                    ...
                                    <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                        <img class="img-responsive media-object wp-post-image" src="assest/front/images/blank.gif" data-echo="assest/front/images/product-cards/6.jpg" alt="">
                                    </a>
        ...
        <div class="home-v1-banner-block animate-in-view fadeIn animated" data-animation="fadeIn">
            <div class="home-v1-fullbanner-ad fullbanner-ad" style="margin-bottom: 70px">
                <a href="#"><img src="assest/front/images/blank.gif" data-echo="assest/front/images/banner/home-v1-banner.png" class="img-responsive" alt=""></a>
            </div>
                            ...
                            <div class="product-outer">
                                <div class="product-inner">
                                    ...
                                    <a href="single-product.html">
                                        <h3>Tablet Thin EliteBook  Revolve 810 G6</h3>
                                        <div class="product-thumbnail">
                                            <img src="assest/front/images/blank.gif" data-echo="assest/front/images/product-category/2.jpg" class="img-responsive" alt="">
                                        </div>
                                    </a>
                            ...
                            <div class="product-outer">
                                <div class="product-inner">
                                    ...
                                    <a href="single-product.html">
                                        ...
                                        <div class="product-thumbnail">
                                            <img src="assest/front/images/blank.gif" data-echo="assest/front/images/product-category/3.jpg" class="img-responsive" alt="">
                                        </div>
                                    </a>
                            ...
                            <div class="product-outer">
                                <div class="product-inner">
                                    ...
                                    <a href="single-product.html">
                                        <h3>Notebook Black Spire V Nitro  VN7-591G</h3>
                                        <div class="product-thumbnail">
                                            <img src="assest/front/images/blank.gif" data-echo="assest/front/images/product-category/1.jpg" class="img-responsive" alt="">
                                        </div>
                                    </a>
                            ...
                            <div class="product-outer">
                                <div class="product-inner">
                                    ...
                                    <a href="single-product.html">
                                        ...
                                        <div class="product-thumbnail">
                                            <img src="assest/front/images/blank.gif" data-echo="assest/front/images/product-category/5.jpg" class="img-responsive" alt="">
                                        </div>
                                    </a>
                            ...
                            <div class="product-outer">
                                <div class="product-inner">
                                    ...
                                    <a href="single-product.html">
                                        <h3>Notebook Purple G952VX-T7008T</h3>
                                        <div class="product-thumbnail">
                                            <img src="assest/front/images/blank.gif" data-echo="assest/front/images/product-category/4.jpg" class="img-responsive" alt="">
                                        </div>
                                    </a>
                            ...
                            <div class="product-outer">
                                <div class="product-inner">
                                    ...
                                    <a href="single-product.html">
                                        ...
                                        <div class="product-thumbnail">
                                            <img src="assest/front/images/blank.gif" data-echo="assest/front/images/product-category/6.jpg" class="img-responsive" alt="">
                                        </div>
                                    </a>
                ...
                <a href="#">
                    ...
                    <figure>
                        <figcaption class="text-overlay">
                         ...
                         <img src="assest/front/images/blank.gif" data-echo="assest/front/images/brands/1.png" class="img-responsive" alt="">
                ...
                <a href="#">
                    ...
                    <figure>
                        <figcaption class="text-overlay">
                         ...
                         <img src="assest/front/images/blank.gif" data-echo="assest/front/images/brands/2.png" class="img-responsive" alt="">
                ...
                <a href="#">
                    ...
                    <figure>
                        <figcaption class="text-overlay">
                         ...
                         <img src="assest/front/images/blank.gif" data-echo="assest/front/images/brands/3.png" class="img-responsive" alt="">
            ...
            <div class="item">
                ...
                <a href="#">
                    ...
                    <figure>
                        ...
                        <img src="assest/front/images/blank.gif" data-echo="assest/front/images/brands/4.png" class="img-responsive" alt="">
            ...
            <div class="item">
                ...
                <a href="#">
                    ...
                    <figure>
                        ...
                        <img src="assest/front/images/blank.gif" data-echo="assest/front/images/brands/5.png" class="img-responsive" alt="">
            ...
            <div class="item">
                ...
                <a href="#">
                    ...
                    <figure>
                        ...
                        <img src="assest/front/images/blank.gif" data-echo="assest/front/images/brands/6.png" class="img-responsive" alt="">
